...
short =
   ...
   ["a black veil"]                        = "AM",
   ["a simple black turban"]               = "DJB",
   ["a gold-and-mahogany ring"]            = "NNa",
   ["a gold-and-red coral ring"]           = "NNb",
...
--          formatted_list = formatted_list .. " - " .. value .. ending -- add indent for five/six/seven/some/pint (removed 2025-05-19)
         ...
         elseif string.sub(value,0,12) == "a black veil" or string.sub(value,0,12) == "a simple bla" or string.sub(value,0,12) == "a delicate h" then  -- veil, turban, amulet
