...
# serial in FTDI
printf "\e[1;32m%b\e[0m" "Reading FTDI serial number (lsusb)\n"
usbsn | awk '{$1=$1;print}' >> ~/.prodtest-$hexstamp  #  USB serial number

# BMC: serial, version, PCIe
printf "\e[1;32m%b\e[0m"  "Reading BMC serial number / version / PCIe status (info and srread 0xC008C)\n"
...
# 1FDC
printf "\e[1;32m%b\e[0m" "Reading OS info (lspci)\n"
1fdc | awk '{$1=$1;print}' >> ~/.prodtest-$hexstamp  # PCIe without leading spaces

# ant22 and dma
printf "\e[1;32m%b\e[0m"  "Running all DMA tests...\n"
