...
cat "/home/ec/HJS/u22/edgecortix.bash_aliases" | grep -E ' s2i=| bios=| usbsn=| ver=| prodtest=| pt=| xerr=| 1fdc=| s2=| info=| c008c=| dmadual=| dmasingle=| dryi=| dry=' | sed 's/\/HJS\//\/hjs\//g' | tee -a $foo
