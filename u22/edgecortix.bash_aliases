...
alias s2res="\cp -v ~/HJS/u22/results-mera22.html ~/mera_package/examples/results.html ; \cp -v ~/HJS/u22/img/eci.svg ~/mera_package/examples/eci.svg"
alias prodtest="source ~/HJS/mfg/prodtest.sh"
alias pt="source ~/HJS/mfg/prodtest.sh"
alias pt+="echo 'The world is a vampire' > ~/.auto_prodtest && echo 'prodtest is (already?) enabled'"
alias pt-="rm ~/.auto_prodtest > /dev/null 2>&1 || echo 'prodtest already disabled'"
