...
alias mera-a="cd ~/S1LP/install_mera/ && source start.sh && mera --version && mera --sakura1_start"
alias mera-b="cd ~/S1LP-847/install_mera/ && source start.sh && mera --version && mera --sakura1_start"
...
alias mera-setup-a="cd ~/Downloads/ && cp -v /media/ec/EC/mera-1.6/*.tar.gz . && tar xvzf sakura-demo.tar.gz && cd sakura_demo && mv * ~/S1LP/ && cd ~/S1LP/install_mera/ && source install.sh && deactivate"
alias mera-setup-b="cd ~/Downloads/ && cp -v /media/ec/EC/mera-1.6-847/*.tar.gz . && tar xvzf sakura_demo_mera-1.6.0+pkg847.tar.gz && cd sakura_demo && mv * ~/S1LP-847/ && cd ~/S1LP-847/install_mera/ && source install.sh && deactivate"
...
alias ver="printf '\n\e[1;35m   HJS aliases v2.33\e[0m\n\n'"
# EOF
