...
alias xx="xlog && echo Pass-Fail-Error && xerr"
alias xxx="xxlog && echo Pass-Fail-Error && xerr"
...
alias detr="source ~/HJS/u22/model.sh"
alias old__detr="cd ~/S2xx/examples/detr && chmod +x ./run.sh && ./run.sh"
...
alias old__ant="cd ~/S2LP/dna2_self_test && ./setup.sh ; echo ; echo Ensure that compute blocks 01 and 02 are enabled, then ./run.sh or ./run.sh 999"
...
# Version
alias ver="printf '\n\e[1;35m   HJS aliases v3.46\e[0m\n\n'"
# EOF
