...
alias mera-setup-b="cd ~/Downloads/ && cp -v /media/ec/EC/mera-1.6-847/*.tar.gz . && tar xvzf sakura-demo.tar.gz && cd sakura_demo && mv * ~/S1LP-847/ && cd ~/S1LP-847/install_mera/ && source install.sh && deactivate"
