...
alias sysinfo="cd ~/hjs && source sysinfo.sh"
alias deb="cat /etc/debian_version"
...
alias tiu="source ~/prodtest/bin/tiu.sh"
...
alias epoch="source ~/prodtest/bin/epochx.sh"
alias epochd="source ~/prodtest/bin/epochd.sh"
...
alias cex="source ~/prodtest/bin/cex.sh"
...
alias pt+="echo 'enabling auto-prodtest' ; echo '1' > ~/.auto_prodtest"
...
alias y+="t0 && dryi && cd ~/dna2_self_test_2_2_0/ && ./run_3pg_yolo.sh 100000 && tt"
alias homer="source ~/prodtest/bin/homer.sh"
...
# Version
alias ver="printf '\n\e[1;35m   HJS aliases v5.00\e[0m\n\n'"
# EOF
