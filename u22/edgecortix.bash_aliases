...
alias xerrf="cat ~/zog.info | grep -i -E 'fail|errors|error|fault' || echo None"
...
alias s2res="\cp -v ~/HJS/u22/results-mera22.html ~/S2xx/examples/results.html ; \cp -v ~/HJS/u22/results-mera22.html ~/mera_package/examples/results.html ; \cp -v ~/HJS/u22/img/eci.svg ~/mera_package/examples/eci.svg"
...
alias bistn="printf '\n\e[1;31mRun xxf afterwards!\e[0m\n' && source ~/HJS/mfg/bistn.sh"
...
# Version
alias ver="printf '\n\e[1;35m   HJS aliases v3.70\e[0m\n\n'"
# EOF
