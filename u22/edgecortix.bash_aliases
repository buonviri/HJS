...
alias bmc="python3 ~/HJS/statlog/statlog.py S2XX-info-void | tee ~/bmc.info && printf '\nBoth should be 0x18 on dual cards\n' && python3 ~/HJS/statlog/statlog.py S2LP-srread.a.0xC008C+srread.b.0xC008C-void | tee -a ~/bmc.info"
...
# Version
alias ver="printf '\n\e[1;35m   HJS aliases v3.51\e[0m\n\n'"
# EOF
