...
alias mera722="cd ~/S1LP/install_mera/ && source start.sh && mera --version && mera --sakura1_start"
alias mera847="cd ~/S1LP-847/install_mera/ && source start.sh && mera --version && mera --sakura1_start"
...
alias mera722-setup="cd ~/Downloads/ && cp -v /media/ec/EC/mera-1.6/*.tar.gz . && tar xvzf sakura-demo.tar.gz && cd sakura_demo && mv * ~/S1LP/ && cd ~/S1LP/install_mera/ && source install.sh && deactivate"
alias mera847-setup="cd ~/Downloads/ && cp -v /media/ec/EC/mera-1.6-847/*.tar.gz . && tar xvzf sakura_demo_mera-1.6.0+pkg847.tar.gz && cd sakura_demo && mv * ~/S1LP-847/ && cd ~/S1LP-847/install_mera/ && source install.sh && deactivate"
...
alias fym-a="cd ~/S1LP/demos/fused_yolov5m_monodepth/ && python deploy.py && python demo_model.py && eog *.png"
alias mde-a="cd ~/S1LP/demos/monodepth_depth_estimation_demo/ && python deploy.py && python demo_model.py && eog *.png"
alias yod-a="cd ~/S1LP/demos/yolov5_object_detection_demo/ && python deploy.py && python demo_model.py && eog *.png"
alias fym-b="cd ~/S1LP-847/demos/fused_yolov5m_monodepth/ && python deploy.py && python demo_model.py && eog *.png"
alias mde-b="cd ~/S1LP-847/demos/monodepth_depth_estimation_demo/ && python deploy.py && python demo_model.py && eog *.png"
alias yod-b="cd ~/S1LP-847/demos/yolov5_object_detection_demo/ && python deploy.py && python demo_model.py && eog *.png"
...
alias ver="printf '\n\e[1;35m   HJS aliases v2.34\e[0m\n\n'"
# EOF
