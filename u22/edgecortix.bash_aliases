...
alias s2res="\cp -v ~/HJS/u22/results-mera22.html ~/S2xx/examples/results.html ; \cp -v ~/HJS/u22/results-mera22.html ~/mera_package/examples/results.html ; \cp -v ~/HJS/u22/eci.svg ~/mera_package/examples/eci.svg"
